...
print("First phone create with name \(firstPhone.name), phone os version: \(firstPhone.osVersion)")

director.setBuilder(firstBuilder: secondiPhoneBuilder)
director.constuctPhone()
let secondPhone = director.getPhone()
print("Second phone create with name \(secondPhone.name), phone os version: \(secondPhone.osVersion)")
